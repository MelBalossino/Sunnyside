  ...
  return (
    <nav className="sm:h-[24px]">
      ...
      sm:py-0 sm:relative sm:text-white`}>
        ...
        <li className='cursor-pointer bg-Yellow w-[120px] h-[46px] grid place-content-center rounded-full font-Fraunces text-Very-dark-desaturated-blue sm:bg-white sm:hover:bg-opacity-25 sm:hover:text-white'>CONTACT</li>
      </ul>
